...
class MCDStrategy(ALStrategy):
    def __init__(self, name='MCDStrategy'):
        self.name = name

    def query(self, opts, folderDict, man, data_query, CLSample, NumSamples=10, pred_class='XMaskPred', batchsize=None, save_uc=False, device='cuda', previous=True, NumRounds=10, NumSamplesMax=15000, dropout_rate=0.1):
