...
class _ConsistentMCDropout(Module):
    ...
    def _create_mask(self, input, k):
        ...
        print('mask_shape1234', mask_shape)
...
def constDropout(p=0.5, const=False):
    if const:
        print('Using ConsistentMCDropout2d for dropout!')
        return ConsistentMCDropout2d(p=p)
    else:
        print('Using torch.nn.Dopout for dropout!')
